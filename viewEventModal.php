<script>
    function viewEvent(eventID){
        ...
        document.getElementById("caseIDD").value = event['case_ID'];
        document.getElementById("eventtt").value = event['event'];
        document.getElementById("eventStartTime").value = event['starttime'];
    }

</script>
﻿<!-- Modal -->
<div id="viewEvent" class="modal fade" role="dialog" style="direction:rtl; height: 450px;">
                        ...
                        <div class="panel-body" style="direction:rtl;" >
                            <form id="addMission" class="form-horizontal" role="form" action="DBS/updateEvent.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="caseIDD" name="caseID">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input required="" type="text" id="eventtt" class="form-control" name="eventtt" placeholder=" ">
                                    </div>
                                </div>
                                <div class="form-group">
