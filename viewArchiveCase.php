...
$case = getArchiveCasesByID($_GET['id']);
          ...
          <div class="panel-body">
           <div>            
            <div class="case02-heading" style="direction: rtl;">
              <h5>قضية للموكل: <?php echo $customer[0]['cfname'].' '.$customer[0]['csname'].' '.$customer[0]['ctname'].' '.$customer[0]['clname'];  ?></h5>
              <button type="button" class="btn btn-danger">مؤرشفة</button> 
            </div>
            ...
            <tbody>
              ...
              <div class="tab-pane" id="case-tab-05">
                     <div class="panel panel-default"> 
                        ...
                        <iframe class="embed-responsive-item" 
                                src="elfinder/elfinder.php?archive=yes&id=<?php echo $idd."&level=".$level; ?>&todid=<?php echo $_GET['id'] ;?>" 
                                width="100%" ></iframe>
                            </div> 
                         </div>
                     </div>
