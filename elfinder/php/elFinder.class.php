...
class elFinder {
	...
	public function __construct($opts) {
		...
		// check session cache
		$_optsMD5 = md5(json_encode($opts['roots'],JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
	...
	public function exec($cmd, $args) {
		...
		if (!empty($result['callback'])) {
			$result['callback']['json'] = json_encode($result,JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
