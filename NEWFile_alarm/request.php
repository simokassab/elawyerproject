...
if((isset($_GET['id']))) {
	...
	$query = "Select * from alarm_form where ID=$id";
		...
		//	alert(customerid);
            ...
            $.ajax({
                ...
                success: function (dataa) {
					notif({
						msg: "لقد تم فتح ملف الإنذار  بنجاح... الرجاء المتابعة..",
						type: "info"
					});
					//alert(dataa);
					if (dataa.indexOf('&') > -1) {
					...
					setTimeout(
							function () {
								window.location.href = "index.php?action=alarm&id_alarm="+s[0];
							}, 3000);
					}
					else {
						setTimeout(
								function () {
							window.location.href = "index.php?action=NEWFile_alarm/customer&id="+dataa;
						}, 3000);
					}
                }
            });
		...
		<div class="table-responsive">
			<table class="table">
				...
				<tr>
					<td>
						<input required="" type="text" disabled="disabled"
							   value="<?php if($customerid=='0') echo $customer; else echo $cust[0]['cfname']; ?>"
							   class="form-control" name="customer" id="customer" placeholder="الإسم الأول">
					</td>
					<td>
						<input required="" type="text" disabled="disabled"
							   value="<?php if($customerid=='0')  echo $customer2; else echo $cust[0]['csname'] ?>"
							   class="form-control" name="customer2" id="customer2" placeholder="الإسم الثاني">
					</td><td>
						<input required="" type="text" disabled="disabled"
							   value="<?php if($customerid=='00')  echo $customer3; else echo $cust[0]['ctname'] ?>"
							   class="form-control" name="customer3" id="customer3" placeholder="الإسم الثالث">
					</td>
					<td>
						<input required="" type="text" disabled="disabled"
							   value="<?php if($customerid=='0')  echo $customer4; else echo $cust[0]['clname'] ?>"
				...
				<tr>
					<td colspan="4">
						<input required="" type="text" class="form-control" disabled="disabled"
							   value="<?php if($customerid=='0')  echo $IDNUMBER; else echo $cust[0]['CID_number'] ?>"
				...
				<tr>
					<td colspan="2">
						<input required="" type="text"  disabled="disabled"
							   value="<?php if($customerid=='0')  echo $t1;else echo $cust[0]['cphone1'] ?>"
							   class="form-control" name="t1" id="t1" placeholder="Tel 1">
					</td>
					<td>
						<input  type="text"  disabled="disabled"
								value="<?php if($customerid=='0')  echo $t2; else echo $cust[0]['cphone2'] ?>"
								class="form-control" name="t3" id="t3" placeholder="Tel 3">
					</td>
					<td>
						<input  type="text"  disabled="disabled"
								value="<?php if($customerid=='0')  echo $t3;else echo $cust[0]['cphone3'] ?>"
				...
				<tr>
					<td colspan="2	">
						<input  type="text"  disabled="disabled"
								value="<?php if($customerid=='0')  echo $t4; else echo $cust[0]['cphone4'] ?>"
								class="form-control" name="t2" id="t2" placeholder="Tel 2">
					</td>
					<td>
						<input  type="text"  disabled="disabled"
								value="<?php if($customerid=='0')  echo $t5; else echo $cust[0]['cphone5'] ?>"
								class="form-control" name="t4" id="t4" placeholder="Tel 4">
					</td>
					<td>
						<input  type="text"  disabled="disabled"
								value="<?php if($customerid=='0')  echo $t6; else echo $cust[0]['cphone6'] ?>"
