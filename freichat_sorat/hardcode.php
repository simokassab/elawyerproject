<?php
/* Data base details */
$dsn='mysql:host=localhost;dbname=freichat_sorat'; //DSN
$db_user='root'; //DB username 
$db_pass=''; //DB password 
$driver='Custom'; //Integration driver
$db_prefix=''; //prefix used for tables in database
$uid='5c87613f96ae3'; //Any random unique number

$connected='YES'; //only for custom installation

$PATH = 'freichat_sorat/'; // Use this only if you have placed the freichat folder somewhere else
$installed=true; //make it false if you want to reinstall freichat
$admin_pswd='kassab'; //backend password 
