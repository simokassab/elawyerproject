...
function freichatx_get_hash($ses){
        ...
        if(is_file("/freichat_".$_SESSION['office']."/hardcode.php")){
			require "/freichat_".$_SESSION['office']."/hardcode.php";
...
?>
<script type="text/javascript" language="javascipt" src="http://localhost/elawyerfinal/freichat_<?php echo $_SESSION['office'];?>/client/main.php?id=<?php echo $ses;?>&xhash=<?php echo freichatx_get_hash($ses); ?>"></script>
    <link rel="stylesheet" href="http://localhost/elawyerfinal/freichat_<?php echo $_SESSION['office'];?>/client/jquery/freichat_themes/freichatcss.php" type="text/css">