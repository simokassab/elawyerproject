        ...
        $("#send").click(function () {
            ...
            if (valid == true) {
                $.ajax({
                    ...
                    +'&to_user='+to_user+'&nextdate='+nextdate,
                    success: function (dataa) {
                        // alert(dataa);
                        notif({
                            msg: "لقد تم إرسال الطلب إلى السكرتير ",
                            type: "success"
                        });
                         setTimeout(
                                function()
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title" style="direction:rtl;" ><b>بيان إستشاري جديد ل: <?php echo $fname." ". $lname; ?>	</b>
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <select class="form-control" id="ctype" >
                        <option value="" selected disabled>نوع الإستشار</option>
        ...
        <div class="form-group">
            ...
            <label for="lastname" id="lname" class="col-md-3 control-label">إسم الموكل: </label>
        </div><br/><br/>
            <?php
            }
            ?>
            ...
            <div  style='padding-top: 50px;'>
                <label style="float: right" for="firstname" class="col-md-3 control-label">موعد مقترح :</label>
                <div class="col-md-9">
                    <input   type="text" id="nextdatee" class="form-control" name="nextdatee" placeholder="">
                </div>
            </div><br/><br/>
            <div class="form-group">
                <div class="col-md-9">
                    <textarea class="form-control" style="resize: none;" rows="4" required="required" id="description" placeholder=" تفاصيل الإستشارة"><?php echo trim($desc); ?></textarea>
                </div>
