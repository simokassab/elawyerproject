<?php $id_logged=$_SESSION['user']['idd'];
//echo  $id_logged;?>   
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title" style="direction:rtl;" ><b>طلب إستشارة</b>
        ...
        <div class="panel-body" style="direction:rtl;" >
            ...
            <div class="form-group">
                ...
                <label for="ffname" style="display: none"  id="fffname" class="col-md-3 control-label">إسم الموكل* :</label>
                <div class="col-md-9">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <input required="" type="text" class="form-control" id="subject" name="subject" placeholder="موضوع الإستشارة وعنوانها">
                </div>
                <label for="subject" id="sub" class="col-md-3 control-label">موضوع الإستشارة وعنوانها* :</label>
            </div><br/><br/><br/>
            <div class="form-group">
                <div class="col-md-9">
                    <textarea class="form-control" style="resize: none;" rows="7" required="required" id="description" placeholder=" تفاصيل الإستشارة"></textarea><br/><br/>
                </div>
