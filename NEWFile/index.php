...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title" style="direction:rtl;" ><b>إستمارة فتح ملف</b>
			<br/><br/>
		</div>
	</div>
	...
	<div class="panel panel-primary" style="direction:rtl;">
		<div class="table-responsive">
			<table class="table">
				...
				<tr>
					<td>
						<input  type="text"  class="form-control" name="opponent" id="opponent" placeholder="الإسم الأول">
					</td>
					<td>
						<input type="text" class="form-control" name="opponent2" id="opponent2" placeholder="الإسم الثاني">
					</td><td>
						<input  type="text" class="form-control" name="opponent3" id="opponent3" placeholder="الإسم الثالث">
					</td>
					<td>
				...
				<tr>
					<td colspan="4">
						<input  type="text" class="form-control" name="OPIDNUMBER" id="OPIDNUMBER" placeholder="الرقم المدني">
					</td>
				</tr>
				<tr>
					<td colspan="2	">
						<input  type="text" class="form-control" name="opt1" id="opt1" placeholder="Tel 1">
					</td>
					<td>
			...
			<div class="form-group">
				<div class="col-md-9">
					<select class="form-control" id="ctype" name="ctype" required="required">
						<option value="" selected disabled>نوع القضية</option>
						<?php
	...
	<div class="panel-body" style="direction:rtl;" >
		<div class="form-group">
			<div class="col-md-9">
				<textarea class="form-control" value="<?php echo $desc; ?>" style="resize: none;" rows="12" required="required" id="details" name="details" placeholder="تفاصيل الدعوى"><?php echo $desc; ?></textarea>
			</div>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body" style="direction:rtl;" >
			...
			<div class="form-group">
				<div class="col-md-9">
					<input required="" type="text" value='0' class="form-control" id="paid" name="paid" placeholder="المبلغ المدفوع">
				</div>
	...
	<div class="panel panel-danger">
		...
		<div class="panel-body" style="direction:rtl;" >
			...
			<div class="form-group">
				<div class="col-md-9">
					<select class="form-control" id="consultant" name="consultant"   >
						<option value="" selected disabled>المستشار</option>
						<?php
			...
			<div class="form-group">
				<div class="col-md-9">
					<textarea class="form-control" style="resize: none;" rows="10"   id="comments" name="comments" placeholder="الملاحظات"></textarea>
				</div>
