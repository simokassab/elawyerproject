...
<script language="javascript">
        $(document).ready(function () {
            ...
            var alarmid=getUrlParameter('alarmid');
            ...
            if(result==''){
                ...
                setTimeout(
                    function () {
                        window.location.href = "index.php?action=alarm&id_alarm="+alarmid;
                    }, 3000);
            }
            ...
            if(result=='1'){
                ...
                setTimeout(
                    function () {
                        window.location.href = "index.php?action=NEWFile_alarm/customer&id="+alarmid;
                        }, 3000);
            }
            if(result=='2'){
...
<form id="addAlarm" name="addAlarm" class="form-horizontal" role="form" action="DBS/addAlarm.php" method="post">
                ...
                <div class="panel panel-danger">
                      <div class="panel-heading c-list">
                        ...
                        <div class="panel panel-warning  ">
                          <div class="panel-heading c-list">
                            <span class="title">معلومات عن الإنذار</span>
                           </div>
                            <div class="panel-body" style="direction:rtl;" >
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label style="float: right" for="firstname" class="col-md-3 control-label">نوع الإنذار</label>
                                    <div class="col-md-9">
