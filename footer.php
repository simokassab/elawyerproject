...
<script type="text/javascript">
    ...
    Yamli.yamlify( "descriptionn", { settingsPlacement: "inside" } );
     ...
     Yamli.yamlify( "cust_desc", { settingsPlacement: "inside" } );
     Yamli.yamlify( "customer4", { settingsPlacement: "inside" } );
     Yamli.yamlify( "customer", { settingsPlacement: "inside" } );
     Yamli.yamlify( "customer2", { settingsPlacement: "inside" } );
     Yamli.yamlify( "customer3", { settingsPlacement: "inside" } );
     Yamli.yamlify( "opponent2", { settingsPlacement: "inside" } );
     Yamli.yamlify( "opponent4", { settingsPlacement: "inside" } );
     Yamli.yamlify( "opponent3", { settingsPlacement: "inside" } );
     Yamli.yamlify( "opponent", { settingsPlacement: "inside" } );
     Yamli.yamlify( "opponent_desc", { settingsPlacement: "inside" } );
    }
</script>