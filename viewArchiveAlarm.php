...
$alarm = getArchiveAlarmByID($_GET['id']);
          ...
          <div class="panel-body">
           <div>            
            <div class="case02-heading" style="direction: rtl;">
              ...
              <button type="button" class="btn btn-success">مؤرشفة</button> 
            </div>
            ...
            <tbody>
              ...
              <div class="tab-pane" id="case-tab-05">
                     <div class="panel panel-default"> 
                        ...
                        <iframe class="embed-responsive-item" 
                                src="elfinder/elfinder.php?archive=yes&alarm=yes&id=<?php echo $idd."&level=".$level; ?>&todid=<?php echo $_GET['id'] ;?>" 
                                width="100%" ></iframe>
                            </div> 
                         </div>
                     </div>
