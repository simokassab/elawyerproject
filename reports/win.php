...
$('#container').highcharts({
        ...
        title: {
            text: 'القضايا الرابحة لكل محامي'
        },
		credits: {
			 text: 'Techoffice.co',
...
mysqli_query($con, "SET NAMES 'utf8'");
mysqli_query($con, 'SET CHARACTER SET utf8');
$query="SELECT cases.lawyer_id as lawyerid , count(cases.ID) as countt from users, cases where users.ID=cases.lawyer_id and cases.status='WON' group by lawyerid";
$result = mysqli_query($con, $query);
