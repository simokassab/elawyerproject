...
<script>
    function viewUser(UserID) {
       ...
       // alert();
        document.getElementById("user_image").src="<?php echo  "DBS/uploads/" ?>"+user['photo'];
        document.getElementById("ffname").value=user['fname'];
        document.getElementById("ssname").value=user['sname'];
        document.getElementById("ttname").value=user['tname'];
        document.getElementById("llname").value=user['lname'];
                        ...
                        <form id="signupform" class="form-horizontal" enctype="multipart/form-data" role="form" action="DBS/updateMyProfile.php" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input id="file-0a" required="false"  name="fileToUpload" class="file" type="file" multiple data-min-file-count="1">
                                </div>
                            </div>
                            <div class="form-group">
                                <label style="float: right" for="firstname" class="col-md-3 control-label">الاسم الاول</label>
                                <div class="col-md-9">
                                    <input required="" type="text" class="form-control" id="ffname" name="fname" placeholder=" ">
                                </div>
                            </div>
                            <div class="form-group">
                                <label style="float: right" for="firstname" class="col-md-3 control-label">الاسم الثاني</label>
                                <div class="col-md-9">
                                    <input required="" type="text" id="ssname" class="form-control" name="sname" placeholder=" ">
                                </div>
                            </div>
                            <div class="form-group">
                                <label style="float: right" for="firstname" class="col-md-3 control-label">الاسم الثالث</label>
                                <div class="col-md-9">
                                    <input required="" type="text" id="ttname" class="form-control" name="tname" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label style="float: right" for="email" class="col-md-3 control-label">اسم العائلة</label>
                                <div class="col-md-9">
                                    <input required="" type="text" id="llname" class="form-control" name="lname" placeholder=" ">
                                </div>
                            </div>
                            <div class="form-group">
