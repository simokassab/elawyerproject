...
$casess=array();
if(isset($_GET['id']))
    $casess=getCaseByID($_GET['id']);

?>

<!-- Modal -->
<div id="addMissionByCase" class="modal fade" role="dialog" style="direction:rtl; height:700px;">
                        ...
                        <div class="panel-body" style="direction:rtl;" >
                            <form id="addMission" class="form-horizontal" role="form" action="DBS/addMission.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input disabled="" value="<?php echo $casess[0]['subject'].'_'.$casess[0]['ID']; ?>" type="text" id="CaseName" class="form-control" name="CaseName" placeholder="">
                                    </div>
                                </div>
                                <input type="hidden" name="caseid" value="<?php echo $casess[0]['ID']; ?>" id='caseid'>
                                <input type="hidden" name="ByCase" value="1" id='ByCase'>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select  type="text" class="form-control" name="priority" placeholder=" ">
