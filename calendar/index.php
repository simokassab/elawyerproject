...
if (mysqli_num_rows($result) > 0) {
   ...
   // }
   // else {
    //    header("location: index?action=consultation/request&id=".$_GET['id']);
   // }
}
        ...
        $(document).ready(function() {
           $("#alert").modal();
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events: "calendar/events.php?id="+conss,
                selectable: true,
            ...
            function doSubmit(){
                if($('#title').val()!=""){
                 if(window.location.hostname=='localhost') 
                    {
                         var urll='http://'+ window.location.hostname +'/elawyer/index.php?action=consultation/request';
                    }
                    else 
                    {
                        var urll='http://'+ window.location.hostname +'/elawyer/index.php?action=consultation/request';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style='height:150px;'>
                <button type="button" class="close" data-dismiss="alert">&times;</button><b>
                    لقد تم قبول طلب الإستشارة من مدير المكتب.
                    <br/><br/><br/>
                الرجاء أخذ موعد للمراجع.
                </b> <br/> <br/>
                <i>
                موعد مقترح : <?php echo $_GET['nextdate']; ?></i>   
                 </div>
            <!-- dialog buttons -->
