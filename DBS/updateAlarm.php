...
EditAlarm($_POST['cid'], $_POST['caseTypeID'], $_POST['lawyer_ID'], $cons, $_POST['caseSubject'], $_POST['description'], $_POST['status']);
header("Location: ../index.php?action=viewAlarm&id=".$_POST['cid']);
