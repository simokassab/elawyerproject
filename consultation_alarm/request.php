    ...
    <script language="javascript">
        $(document).ready(function () {
            ...
            $("#opencase").click(function () {
                ...
                window.location.href="index.php?action=NEWFile_alarm/index&act=opencase&fname="+fname+"&lname="+lname+"&customer="+customer+
            ...
            $("#sec_appoint").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (dataa) {
                        notif({
                            msg: "لقد تم إرسال طلب الإنذار إلى المحامي",
                            type: "success"
                        }),
                            setTimeout(
                                function()
...
<?php
if($result=="disabled"){
    echo "<center><h1 style='background-color: red;font-size: x-large;'> لم يتم قبول طلب الإنذار... يرجى مراجعة مدير المكتب</h1></center><br/>";
}
?>
<div class="container">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
               ...
               if(empty($cust)){
                ...
                ?>
                 <div class="panel-title" style="direction:rtl;"><b>طلب إنذار جديد
                        ل: <?php echo $fname . " " . $lname; ?>    </b>
                    <?php
                ...
                ?>
                <div class="panel-title" style="direction:rtl;"><b>طلب إنذار جديد
                        ل: <?php echo $cust[0]['cfname'] . " " . $cust[0]['clname']; ?>    </b>
                    <?php
                    }
                    ?>
                </div>
            ...
            <div class="panel-body" style="direction:rtl;" >
                ...
                <div class="form-group">
                    <div class="col-md-9">
                        <span style="font-size: large;font-weight:bold;">
                            <?php echo $cust[0]['cfname'].' '.$cust[0]['csname'].' '.$cust[0]['ctname'].' '.$cust[0]['clname']; ?>
                         </span><br><br>
                    </div>
                    <label for="lastname" id="lname" class="col-md-3 control-label"> العائلة* :</label>
                </div><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <label for="subject" id="sub" class="col-md-3 control-label">موضوع الإنذار وعنوانه* :</label>
                </div><br/><br/>
                <div class="form-group">
                    <div class="col-md-9">
