          ...
          <div class="panel-body">
           <div>            
            <div class="case02-heading" style="direction: rtl;">
              <h5>إنذار للعميل: <?php echo $customer[0]['cfname'].' '.$customer[0]['csname'].' '.$customer[0]['ctname'].' '.$customer[0]['clname'];  ?></h5>
            </div>
                            ...
                            <div class="panel-body" style="direction:rtl;" >
                                <form id="addMission" class="form-horizontal" role="form" action="DBS/updateAlarm.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input  disabled="" required="" type="text" id="caseSubject" value="<?php echo $alarm['subject'] ?>" class="form-control" 
            ...
            <tbody>
              ...
              <div class="tab-pane" id="case-tab-05">
                     <div class="panel panel-default"> 
                        ...
                        <iframe class="embed-responsive-item" 
                                src="../elfinder/elfinder.php?customer=yes&alarm=yes&id=<?php echo $idd; ?>&todid=<?php echo $_GET['id'] ;?>" 
                                width="100%" ></iframe>
                            </div> 
                         </div>
                     </div>
